...
public class SetBloodSugarLevelsTest extends BaseTest {
    ...
    public void parameterBloodSugarLevelsIsVisibleWithSecondSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(SECOND_VALUE_OF_BLOOD_SUGAR_LEVELS_SUCCESS)
                .goodValueIsVisible(receiveOfData.getLocalDateTime(),
    ...
    public void parameterBloodSugarLevelsIsVisibleWithThirdSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(THIRD_VALUE_OF_BLOOD_SUGAR_LEVELS_SUCCESS)
                .goodValueIsVisible(receiveOfData.getLocalDateTime(),
    ...
    public void parameterBloodSugarLevelsIsVisibleWithFourthSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(FOURTH_VALUE_OF_BLOOD_SUGAR_LEVELS_SUCCESS)
                .goodValueIsVisible(receiveOfData.getLocalDateTime(),
    ...
    public void parameterBloodSugarLevelsIsVisibleWithFifthSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(FIFTH_VALUE_OF_BLOOD_SUGAR_LEVELS_SUCCESS)
                .goodValueIsVisible(receiveOfData.getLocalDateTime(),
    ...
    public void parameterBloodSugarLevelsIsVisibleWithFirstNotSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(FIRST_VALUE_OF_BLOOD_SUGAR_LEVELS_NOT_SUCCESS)
    ...
    public void parameterBloodSugarLevelsIsVisibleWithSecondNotSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(SECOND_VALUE_OF_BLOOD_SUGAR_LEVELS_NOT_SUCCESS)
                .badValueIsVisible(receiveOfData.getLocalDateTime(),
    ...
    public void parameterBloodSugarLevelsIsVisibleWithThirdNotSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(THIRD_VALUE_OF_BLOOD_SUGAR_LEVELSE_NOT_SUCCESS)
                .badValueIsVisible(receiveOfData.getLocalDateTime(),
    ...
    public void parameterBloodSugarLevelsIsVisibleWithFourthNotSuccessValue() {
        healthIndicatorsPage.setIndicatorOfBloodSugarLevels(FOURTH_VALUE_OF_BLOOD_SUGAR_LEVELS_NOT_SUCCESS)
                .badValueIsVisible(receiveOfData.getLocalDateTime(),
